            ...
            <header className='header'>
                <ul>
                    ...
                    <ul className='position-button'>
                        <li>
                            <button onClick={() => window.location.href = `/go/discord`} className='header-button'>
                        ...
                        <li>
                            <button onClick={() => window.location.href = `/go/github`} className='header-button'>
                        ...
                        <li>
                            <button onClick={() => window.location.href = `/go/twitter`} className='header-button'>
